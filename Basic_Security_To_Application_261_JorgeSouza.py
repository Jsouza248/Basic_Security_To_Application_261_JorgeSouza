# Adding Basic Security to an Application, 261, Jorge Souza

from datetime import datetime

def CreateUser():
    print('### Create users, password, and roles ###')
    UserFile = open("user.tex", "a")
    while True:
...
def printinfo(DetailsPrinted):
    ...
    while True: 
        ...
        gross, incometax, netpay = CalcTaxAndNetPay(hours, hourlyrate, taxrate)
